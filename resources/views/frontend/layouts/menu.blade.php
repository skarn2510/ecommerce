...
<style>
    ...
    /* Alag se child categories ke liye style */
    .wsus__child_categories_separate {
        max-height: 200px;
        overflow-y: auto;
            ...
            @if(count($category->subCategories) > 0)
                <ul class="wsus_menu_cat_droapdown">
                    @foreach ($category->subCategories as $subCategory)
                        <li class="wsus_menu_cat_droapdowntest">
                            ...
                            {{-- Child categories ko yahan **show nahi karenge** --}}
                        </li>

                        {{-- Child categories ko subcategory ke baad alag se show karenge --}}
                        @if(count($subCategory->childCategories) > 0)
                            <ul class="wsus__child_categories_separate">
